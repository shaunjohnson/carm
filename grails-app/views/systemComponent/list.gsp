    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="id" title="${message(code: 'systemComponent.id.label', default: 'Id')}"/>
            ...
            <g:each in="${systemComponentInstanceList}" status="i" var="systemComponentInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show" id="${systemComponentInstance.id}">${fieldValue(bean: systemComponentInstance, field: "id")}</g:link></td>

                    <td>${fieldValue(bean: systemComponentInstance, field: "name")}</td>
