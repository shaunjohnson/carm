    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="id" title="${message(code: 'sourceControlServer.id.label', default: 'Id')}"/>
            ...
            <g:each in="${sourceControlServerInstanceList}" status="i" var="sourceControlServerInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show" id="${sourceControlServerInstance.id}">${fieldValue(bean: sourceControlServerInstance, field: "id")}</g:link></td>

                    <td>${fieldValue(bean: sourceControlServerInstance, field: "name")}</td>
