...
<body>
<carm:header domain="${notificationInstance}"
...
<g:form action="save" class="offset1 span8">
    <div class="control-group ${hasErrors(bean: notificationInstance, field: 'name', 'error')}">
        <carm:label class="control-label" for="name" required="true">
            <g:message code="notificationScheme.name.label" default="Name"/>
        </carm:label>
        <div class="controls">
            <g:textField name="name" maxlength="50" size="50"
                         value="${notificationInstance?.name}"
                         required="required"
                         title="${message(code: 'notificationScheme.name.help')}"/>
        </div>
    </div>

    <div class="control-group ${hasErrors(bean: notificationInstance, field: 'description', 'error')}">
        ...
        <div class="controls">
            <g:textArea name="description"
                        ...
                        value="${notificationInstance?.description}"
