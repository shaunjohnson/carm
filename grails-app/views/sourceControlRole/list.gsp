<%@ page import="net.lmxm.carm.SourceControlRole" %>
<html>
<head>
    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="id" title="${message(code: 'sourceControlRole.id.label', default: 'Id')}"/>
            ...
            <g:each in="${sourceControlRoleInstanceList}" status="i" var="sourceControlRoleInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show" id="${sourceControlRoleInstance.id}">${fieldValue(bean: sourceControlRoleInstance, field: "id")}</g:link></td>

                    <td>${fieldValue(bean: sourceControlRoleInstance, field: "name")}</td>
